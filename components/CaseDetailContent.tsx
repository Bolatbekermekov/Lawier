		...
		>
			...
			<div className='pointer-events-none absolute inset-0'>
				...
				<motion.div
					...
					className='absolute -left-40 top-0 h-[600px] w-[600px] rounded-full bg-gradient-to-br from-blue-200 via-indigo-200 to-purple-200 blur-3xl'
				/>
				<motion.div
					animate={{
						scale: [1, 1.3, 1],
					...
					className='absolute -right-40 bottom-0 h-[700px] w-[700px] rounded-full bg-gradient-to-tl from-violet-200 via-blue-200 to-indigo-200 blur-3xl'
				/>
			</div>
			...
			<div className='relative mx-auto max-w-[1600px] px-4 sm:px-6 md:px-8 lg:px-10'>
					...
					<div className='relative overflow-hidden rounded-[30px] bg-white'>
						...
						<div className='relative h-48 sm:h-56 md:h-64 overflow-hidden bg-gradient-to-br from-[#f8faff] via-[#eef4ff] to-[#e0ebff]'>
							...
							<motion.div
								...
								className='absolute -left-24 -top-24 h-80 w-80 rounded-full bg-gradient-radial from-[#6b8fff]/40 to-transparent blur-2xl'
							/>
							<motion.div
								animate={{
									scale: [1, 1.4, 1],
								...
								className='absolute -right-20 -top-20 h-96 w-96 rounded-full bg-gradient-radial from-[#4d73ff]/30 to-transparent blur-2xl'
							/>
							<motion.div
								animate={{
									scale: [1, 1.2, 1],
								...
								className='absolute -bottom-24 -right-24 h-80 w-80 rounded-full bg-gradient-radial from-[#0B3B95]/35 to-transparent blur-2xl'
							/>
				...
				{/* ===== ВАРИАНТ 1: SPLIT LAYOUT (РЕКОМЕНДУЕТСЯ) ===== */}
				<motion.div
						...
						<div className='flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-12'>
							...
							<div className='flex-1 space-y-4'>
								...
								<p className='text-sm sm:text-base md:text-lg text-slate-600 leading-relaxed max-w-xl'>
									Запишитесь на консультацию, чтобы обсудить задачу и узнать, как
									мы поможем добиться выдающихся результатов.
								</p>
							</div>
